        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-2xl feature-card" data-category="security">
                    ...
                    <h3 class="text-xl font-bold text-center mb-3">Laravel Security Features</h3>
                    <p class="text-gray-600 text-center">Laravel provides built-in protection against common vulnerabilities like SQL injection, cross-site scripting (XSS), and cross-site request forgery (CSRF). It also includes robust authentication and encryption mechanisms to safeguard your application.</p>
                </div>
