    ...
    <section class="container mx-auto py-16 px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/expense-tracking.png" alt="Expense Tracking" class="mx-auto w-20 mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/reminders.png" alt="Smart Reminders" class="mx-auto w-20 mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/multi-currency.png" alt="Multi-Currency Support" class="mx-auto w-20 mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/reports.png" alt="Income Reports" class="mx-auto w-20 mb-4">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/cloud-sync.png" alt="Cloud Sync" class="mx-auto w-20 mb-4">
                <h3 class="text-xl font-bold">Cloud Sync</h3>
                <p class="text-gray-600 mt-2">Access and manage your budget anytime, anywhere.</p>
            </div>

            <div class="bg-white p-6 rounded-lg shadow-lg feature-card text-center">
                <img src="/img/security.png" alt="Security & Privacy" class="mx-auto w-20 mb-4">
