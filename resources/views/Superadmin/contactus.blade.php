...
<body class="bg-[#f9f6f2] font-sans">
  ...
  <header class="gradient-header text-center py-20 px-4">
    ...
    <p class="text-lg max-w-2xl mx-auto">
      Got a question, suggestion, or just want to say hello? We’d love to hear from you. Whether you're facing a
      technical issue,
  ...
  <section class="container-bg py-20 px-6 md:px-20">
    <div class="grid md:grid-cols-2 gap-12 max-w-7xl mx-auto">
      ...
      <!-- Contact Info Card -->
      <div class="card-gradient bg-white p-8 rounded-2xl shadow-md contact-card">
        <h2 class="text-2xl font-bold mb-6">Reach Out</h2>
        <p class="mb-4">We’re committed to providing you with the support you need. Whether it's a quick inquiry or a
          detailed discussion, don't hesitate to drop us a line.</p>
      ...
      <div class="card-gradient bg-white p-8 rounded-2xl shadow-md contact-card">
        ...
        <p class="mb-6">Fill out the form below and we’ll get back to you within 24-48 hours. We appreciate your
          patience and look forward to connecting with you!</p>
  ...
  <section class="gradient-cta py-20 text-center">
    ...
    <p class="text-lg max-w-xl mx-auto mb-6">Whether you're planning a monthly budget, saving for a goal, or just trying
      to understand your expenses better — WalletWise is your trusted companion.</p>
    <p class="text-lg max-w-xl mx-auto mb-6">We’re more than a tool — we’re your financial partner. Let's make your
      money work for you, not the other way around.</p>
    <a href="/register"
