  ...
  <section class="relative overflow-hidden gradient-bg py-24 text-center">
    ...
    <div class="container mx-auto px-6 relative z-10">
      ...
      <p class="text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
        Whether you have questions about features, need support, or want to provide feedback - our team is ready to
        assist you.
      </p>

      {{-- <div class="mt-12">
        <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_5tkpblhp.json" background="transparent"
          speed="1" style="width: 300px; height: 300px; margin: 0 auto;" loop autoplay class="floating"></lottie-player>
      </div> --}}
    </div>
  </section>
  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-6">
      <div class="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
        <!-- Contact Info -->
        <div
          class="bg-gradient-to-b from-amber-50 to-white p-10 rounded-2xl contact-card animate__animated animate__fadeInLeft">
          <h2 class="text-2xl font-bold mb-6">Get in Touch</h2>
          <p class="mb-8 text-gray-600 leading-relaxed">
            Our support team is committed to providing timely and helpful responses to all your inquiries. Choose your
          ...
          <div class="space-y-6">
            <div class="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:support@walletwise.com"
                  class="text-gray-600 hover:text-amber-700 transition">support@walletwise.com</a>
              </div>
            </div>
          ...
          <div class="mt-10">
            ...
            <div class="flex space-x-4">
              <a href="#" class="social-icon text-gray-600 hover:text-amber-600 text-xl"><i
        ...
        <!-- Contact Form -->
        <div
          class="bg-gradient-to-b from-amber-50 to-white p-10 rounded-2xl contact-card animate__animated animate__fadeInRight">
          <h2 class="text-2xl font-bold mb-6">Send a Message</h2>
          <p class="mb-8 text-gray-600 leading-relaxed">
            Fill out the form below and we'll get back to you within 24 hours. For immediate assistance, please call our
            support line.
          </p>
      ...
      @endif
          ...
          <form method="POST" action="{{ route('contact.store') }}" class="space-y-6">
            ...
            <button type="submit"
              class="btn-primary text-white px-6 py-3 rounded-lg w-full font-semibold shadow hover:shadow-lg transition">
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
          ...
          <p class="text-gray-600">
            Yes! WalletWise offers a free plan with all essential features. We also have premium plans with additional
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
          ...
          <p class="text-gray-600">
            WalletWise integrates Laravel's built-in security features such as CSRF protection, input validation, and
            secure password hashing to ensure your data remains safe.
          </p>
        </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
          ...
          <p class="text-gray-600">
            Absolutely! Many small businesses use WalletWise to track expenses and income. We're working on dedicated
            business features.
          </p>
        </div>
      </div>
